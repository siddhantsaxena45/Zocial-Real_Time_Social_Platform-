...
export const getAllPost = async (req, res) => {
    try {
        ...
        // 🛡️ Data Privacy Protocol: Only fetch posts from self or followed professionals
        const allowedAuthors = [...user.following, userId];
...
export const likePost = async (req, res) => {
    try {
        ...
        // Log to SQL Ledger
        logEngagement(likekarnewalekiId, postId, 'like');
        
        // Also log for the post owner if it's someone else's action
        if (postOwnerId !== likekarnewalekiId) {
            logEngagement(postOwnerId, postId, 'received_like');
        }
...
export const addComment = async (req, res) => {
    try {
        ...
        // Log to SQL Ledger
        logEngagement(commentkarnewalekiId, postId, 'comment');

        // Also log for the post owner if it's someone else's action
        const postOwnerId = post.author.toString();
        if (postOwnerId !== commentkarnewalekiId) {
            logEngagement(postOwnerId, postId, 'received_comment');
